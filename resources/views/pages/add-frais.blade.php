    ...
    <form action="#" method="POST" class="space-y-6">
      ...
      <div>
        ...
        <input 
          ...
          id="id_frais" 
          name="id_frais" 
          placeholder="Entrez l'ID du frais"
          required
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input 
            ...
            id="tranche1" 
            name="tranche1" 
            placeholder="Montant de la tranche 1"
            required
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
          />
        </div>
        <div>
          ...
          <input 
            ...
            id="reste_tranche1" 
            name="reste_tranche1" 
            placeholder="Reste de la tranche 1"
            required
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
          />
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input 
            ...
            id="tranche2" 
            name="tranche2" 
            placeholder="Montant de la tranche 2"
            required
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
          />
        </div>
        <div>
          ...
          <input 
            ...
            id="reste_tranche2" 
            name="reste_tranche2" 
            placeholder="Reste de la tranche 2"
            required
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
          />
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input 
            ...
            id="tranche3" 
            name="tranche3" 
            placeholder="Montant de la tranche 3"
            required
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
          />
        </div>
        <div>
          ...
          <input 
            ...
            id="reste_tranche3" 
            name="reste_tranche3" 
            placeholder="Reste de la tranche 3"
            required
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
          />
        </div>
